...
docker compose run --rm freqtrade hyperopt --hyperopt-loss SortinoHyperOptLoss --spaces default trailing --strategy SampleStrategy --config user_data/config.json -e 1000
```
#자동매매