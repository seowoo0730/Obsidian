...
docker compose run --rm freqtrade hyperopt --hyperopt-loss CalmarHyperOptLoss --spaces roi stoploss trailing trades --strategy SampleStrategy --config user_data/config.json --timeframe-detail 1m -e 1000
```
#자동매매