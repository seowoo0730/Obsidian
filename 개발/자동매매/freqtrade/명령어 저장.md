...
docker compose run --rm freqtrade hyperopt --hyperopt-loss SortinoHyperOptLoss --spaces roi stoploss trailing --strategy SampleStrategy --config user_data/config.json --timeframe-detail 1m -e 1000
```
#자동매매